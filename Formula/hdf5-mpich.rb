class Hdf5Mpich < Formula
  ...
  conflicts_with "hdf5", because: "hdf5-mpich is a variant of hdf5, one can only use one or the other"
  conflicts_with "hdf5-mpi", because: "hdf5-mpich is a variant of hdf5, one can only use one or the other"
